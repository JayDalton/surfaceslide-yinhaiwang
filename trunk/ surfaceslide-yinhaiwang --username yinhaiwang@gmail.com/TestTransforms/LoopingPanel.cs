...
#region Input
        ...
        {
            IInputElement scrollViewer = sender as IInputElement;

            if (scrollViewer != null && Contacts.GetContactsCaptured(scrollViewer).Count == 0)
            {
...
#region IScrollInfo Members
        ...
        public bool CanVerticallyScroll
        {
            ...
            set
            {
                if (value)
                {
                    Console.WriteLine("Cannot Scroll virtically!");
                }
            }
        }
        ...
        public ScrollViewer ScrollOwner
        {
            ...
            set
            {
                ...
                if (owner != null)
                {
                    owner.RemoveHandler(Contacts.LostContactCaptureEvent, new RoutedEventHandler(LostInputCapture));
                }
                ...
                if (owner != null)
                {
                    owner.AddHandler(Contacts.LostContactCaptureEvent, new ContactEventHandler(LostInputCapture), true);
                }
            }
        }
        ...
        /// contact has moved by ten pixels. It could be possible that the values match up.  For example,
        ...
        /// should be scrolled to an offset of 25, because the contact moved 10 pixels
        /// </remarks>
        ...
        public void SetHorizontalOffset(double offset)
        {
            if (CanHorizontallyScroll)
            {
                ...
                if (isFlicking && ((SurfaceScrollViewer)owner).ContactsCaptured.Count > 0)
                {
                    previousOffset = double.NaN;
                    isFlicking = false;
                }
